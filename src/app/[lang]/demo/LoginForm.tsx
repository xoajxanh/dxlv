...
export default function LoginForm({ lang, dict }: { lang: string; dict: DictProps }) {
    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-center text-white mb-2">Demo Portal</h1>
          <p className="text-gray-400 text-center text-sm">{dict.demo.loginSubtitle}</p>
        </div>
        ...
        <div className="glassmorphism border border-white/10 rounded-3xl p-8 shadow-2xl">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              {isPending ? dict.login.authenticating : dict.login.submit}
